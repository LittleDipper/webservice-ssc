 ...
 * 2020-06-17T23:15:07.065+08:00
 * Generated source version: 3.1.5
 * 
 */
@WebServiceClient(name = "EnglishChinese", 
                  wsdlLocation = "file:/C:/Users/Sun/workspace/ssh/webservice_ssc_translate/translate.wsdl",
...
public class EnglishChinese extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/Sun/workspace/ssh/webservice_ssc_translate/translate.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EnglishChinese.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/Sun/workspace/ssh/webservice_ssc_translate/translate.wsdl");
        }
        WSDL_LOCATION = url;
    }
